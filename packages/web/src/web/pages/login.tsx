    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-brand-teal px-4">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleTwoFactorSubmit} className="bg-brand-cream rounded-lg p-6 space-y-4 shadow-lg">
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-brand-teal">
              ...
              <input
                ...
                className="w-full h-10 px-3 rounded-md border border-brand-tan/40 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-copper tracking-widest"
            ...
            <button
              ...
              className="w-full text-xs text-brand-teal/70 hover:text-brand-teal underline"
            >
